    ...
    rules: {
      ...
      'no-restricted-syntax': [
        'error',
        {
          ...
          message:
            'Direct session.run() calls are prohibited. Use GraphWriteService for all graph writes. See docs/architecture/safety-guards/graph_ingress_guard_v_0_1.md',
        },
        {
          selector: "CallExpression[callee.name='executeCypher']",
          message:
            'Direct executeCypher() calls are prohibited. Use GraphWriteService for all graph writes. See docs/architecture/safety-guards/graph_ingress_guard_v_0_1.md',
        },
