    ...
    rules: {
      ...
      'no-restricted-syntax': [
        'error',
        {
          ...
          message:
            'Direct session.run() calls are prohibited. Use GraphWriteService for all graph writes. See docs/architecture/safety/safety-guards/graph_ingress_guard_v_0_1.md',
        },
        {
          selector: "CallExpression[callee.name='executeCypher']",
          message:
            'Direct executeCypher() calls are prohibited. Use GraphWriteService for all graph writes. See docs/architecture/safety/safety-guards/graph_ingress_guard_v_0_1.md',
        },
        // ComplianceEngine Bypass Prevention (Phase 3 Architecture)
        {
          ...
          message:
            'Direct llmRouter.streamChat() calls are prohibited in application code. Use ComplianceEngine.handleChatStream() to ensure proper agent routing and graph querying. See docs/architecture/architecture_v_0_4.md',
        },
        {
          selector:
            "CallExpression[callee.object.name='llmRouter'][callee.property.name='chat']",
          message:
            'Direct llmRouter.chat() calls are prohibited in application code. Use ComplianceEngine.handleChat() to ensure proper agent routing and graph querying. See docs/architecture/architecture_v_0_4.md',
        },
      ],
    },
  },
    ...
    rules: {
      'no-restricted-imports': [
        ...
        },
        {
          ...
          message:
            'Direct LlmRouter usage is prohibited in application code. Use ComplianceEngine.handleChat() or ComplianceEngine.handleChatStream() instead. See docs/architecture/architecture_v_0_4.md',
        },
      ],
    },
  },
