...
- [Architecture Overview](../architecture/graph/graph_change_detection_v_0_6.md)
- [Enhancement Details](../architecture/graph/archive/graph_change_detection_enhancements_v_0_3_1.md)
