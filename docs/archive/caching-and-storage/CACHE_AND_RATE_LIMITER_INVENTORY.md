> **ARCHIVED (2026-01-04):** Consolidated into [`docs/architecture/caching-and-storage_failover_v1.md`](../../architecture/caching-and-storage_failover_v1.md).
> Retained for historical reference and detailed compliance inventory.

# Cache and Rate Limiter Inventory

> **Status:** Archived - superseded by canonical doc
