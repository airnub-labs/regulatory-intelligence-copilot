...
- The observability CLI bootstraps the SDK before dumping diagnostics so its execution is captured with structured logs and request context metadata.【F:packages/reg-intel-observability/src/cli.ts†L1-L86】
