...
> Draft spec for the Eligibility Explorer feature (Use Case 1), building on `docs/architecture/versions/architecture_v_0_4.md`, `docs/architecture/versions/architecture_v_0_5.md`, `docs/graph/graph-schema/versions/graph_schema_v_0_4.md`, `docs/engines/timeline-engine/timeline_engine_v_0_2.md`, `scenario_engine_v_0_1.md`, and `docs/graph/concept/versions/regulatory_graph_copilot_concept_v_0_4.md`.
...
These nodes/edges are defined and constrained by `docs/graph/graph-schema/versions/graph_schema_v_0_4.md` and `docs/engines/timeline-engine/timeline_engine_v_0_2.md`.
