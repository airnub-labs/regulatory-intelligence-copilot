...
1. **Concept & high-level architecture**
   ...
   - `architecture/copilot-concept/regulatory_graph_copilot_concept_v_0_6.md`
...
3. **Core schema & engines**
   - `architecture/graph/graph_schema_v_0_6.md`
   - `architecture/graph/graph_schema_changelog_v_0_6.md`
   - `architecture/engines/timeline-engine/timeline_engine_v_0_2.md`
   - `architecture/engines/scenario-engine/scenario_engine_v_0_1.md`
4. **Runtime glue & safety**
   - `architecture/conversation-context/concept_capture_from_main_chat_v_0_1.md`
   - `architecture/conversation-context/conversation_context_spec_v_0_1.md`
   - `architecture/data_privacy_and_architecture_boundaries_v_0_1.md`
   - `architecture/guards/graph_ingress_guard_v_0_1.md`
   - `architecture/guards/egress_guard_v_0_2.md`
5. **Change detection & streaming**
   - `architecture/graph/graph_change_detection_v_0_6.md`
...
2. `architecture/copilot-concept/regulatory_graph_copilot_concept_v_0_6.md`
...
- `architecture/copilot-concept/regulatory_graph_copilot_concept_v_0_6.md` – overall product concept and goals.
- `architecture/graph/graph_schema_v_0_6.md` – node/edge schema for the rules graph.
- `architecture/graph/graph_schema_changelog_v_0_6.md` – how the schema evolved to v0.6.
- `architecture/graph/graph_algorithms_v_0_1.md` – query patterns and optional algorithms.

### Timeline & scenarios

- `architecture/engines/timeline-engine/timeline_engine_v_0_2.md` – modelling temporal rules (lookbacks, lock-ins, deadlines, effective windows) and how the engine is called as a tool.
- `architecture/engines/scenario-engine/scenario_engine_v_0_1.md` – conceptual Scenario Engine for what‑if reasoning; see also `architecture/engines/scenario-engine/archive/scenario_integration_v_0_1.md` if present.

### Conversation context & concept capture

- `architecture/conversation-context/concept_capture_from_main_chat_v_0_1.md` – SKOS-style concept capture via tools in the main chat call (single-call design, streaming-safe).
- `architecture/conversation-context/conversation_context_spec_v_0_1.md` – ConversationContext shape, persistence, and the prompt aspect that injects it into the Compliance Engine.
...
- `architecture/guards/graph_ingress_guard_v_0_1.md` – how all Memgraph writes go through ingress aspects.
- `architecture/guards/egress_guard_v_0_2.md` – how all outbound calls (LLM, MCP, HTTP) go through egress aspects.
...
- `architecture/runtime/node_24_lts_rationale.md` – why Node.js 24 LTS is the minimum runtime.
...
- `architecture/graph/graph_change_detection_v_0_6.md` – current design for patch-based graph change detection and streaming, including nodes/edges created/updated/deleted and `edges_updated` for edge property changes.
