...
- `docs/governance/decisions/versions/decisions_v_0_3.md` (or latest)
- `docs/graph/graph-schema/versions/graph_schema_v_0_3.md` (or latest)
- `docs/engines/timeline-engine/timeline_engine_v_0_2.md` (or latest)
- `docs/graph/special_jurisdictions_modelling_v_0_1.md`
- `docs/dev-notes/node_24_lts_rationale.md` (runtime & security baselines)
