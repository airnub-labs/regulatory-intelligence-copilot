...
**Status:** Current
**Aligned with:** `docs/architecture_v_0_4.md`, `docs/governance/decisions/decisions_v_0_4.md`
...
Per `docs/specs/safety-guards/graph_ingress_guard_v_0_1.md` and decision D-026:
