...
- Any future Node upgrade decisions should be recorded as new entries in `docs/governance/decisions/versions/decisions_v_0_2.md` or a subsequent versioned decisions doc.
