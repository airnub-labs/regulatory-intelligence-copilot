...
These nodes/edges are defined and constrained by `docs/architecture/graph/graph-schema/versions/graph_schema_v_0_4.md` and `docs/architecture/engines/timeline-engine/timeline_engine_v_0_2.md`.
