...
- [ ] Seed IE/UK/NI/IM/EU/CTA graph:
  - [ ] Implement the concrete seed in `special_jurisdictions_graph_seed_ni_uk_ie_eu.cypher`.
...
- [ ] Demo web “What-If” UI:
  ...
  - [ ] Tight integration with chat so users can ask, “What changes if I pick Scenario B instead of A?”
