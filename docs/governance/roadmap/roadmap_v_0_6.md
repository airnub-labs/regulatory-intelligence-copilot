...
- `docs/architecture/graph/archive/graph_schema_v_0_4.md` + `docs/architecture/graph/archive/graph_schema_changelog_v_0_4.md` – rules graph schema.
...
- `docs/architecture/guards/graph_ingress_guard_v_0_1.md` – write‑path guarantees into Memgraph.
- `docs/architecture/guards/egress_guard_v_0_2.md` – outbound HTTP/LLM/MCP guardrails.
...
- `docs/governance/product/eligibility-explorer/eligibility_explorer_spec_v_0_1.md` (once added) – deterministic eligibility evaluation (Use Case 1).
