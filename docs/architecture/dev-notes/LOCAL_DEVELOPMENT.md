...
- **Architecture Decisions**: `docs/governance/decisions/versions/decisions_v_0_5.md`
- **Graph Schema**: `docs/architecture/graph/graph-schema/versions/graph_schema_v_0_4.md`
