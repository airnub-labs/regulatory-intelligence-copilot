...
> **Status:** v0.4  
> **Supersedes:** `docs/architecture/concept/versions/regulatory_graph_copilot_concept_v_0_3.md`  
> **Companion specs:**
...
The graph model (see `docs/architecture/graph/graph-schema/versions/graph_schema_v_0_4.md`) expresses this as:
...
- Backed by `docs/architecture/graph/graph-schema/versions/graph_schema_v_0_4.md` for structure.
...
- Expressed in `docs/architecture/graph/graph-schema/versions/graph_schema_v_0_4.md` using explicit edge types for different time aspects.
