...
- **Main documentation:** `docs/architecture/change-detection/graph_change_detection_v_0_6.md`
- **Architecture spec:** `docs/architecture/versions/architecture_v_0_3.md` (Section 9)
