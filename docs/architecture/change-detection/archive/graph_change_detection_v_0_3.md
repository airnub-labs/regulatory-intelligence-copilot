...
**Per v0.3 architecture** (docs/architecture/versions/architecture_v_0_3.md Section 9):
...
- See `docs/architecture/change-detection/archive/graph_change_detection_enhancements_v_0_3_1.md` for details
...
- **Architecture:** `docs/architecture/versions/architecture_v_0_3.md` (Section 9)
- **Graph Schema:** `docs/architecture/graph/graph-schema/versions/graph_schema_v_0_3.md`
