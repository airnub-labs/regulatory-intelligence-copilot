...
- Any future changes to how these are modelled must:
  ...
  2. Update `docs/architecture/graph/graph-schema/versions/graph_schema_v_0_3.md` (or later version) and the graph
     changelog.

- The example Cypher seed file `docs/architecture/graph/graph_seed_ni_uk_ie_eu.cypher` provides a
