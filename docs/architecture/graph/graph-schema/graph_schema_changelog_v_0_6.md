...
>
> **Status:** Current  
> **Supersedes:** `docs/architecture/graph/graph-schema/versions/graph_schema_changelog_v_0_4.md`
...
**Status:** Current  
**Aligned with:** `architecture_v_0_6.md`, `docs/governance/decisions/decisions_v_0_6.md`  
...
For full details, see `docs/architecture/graph/graph-schema/versions/graph_schema_changelog_v_0_4.md`.
...
- Tight alignment with `docs/architecture/engines/timeline-engine/timeline_engine_v_0_2.md`.
