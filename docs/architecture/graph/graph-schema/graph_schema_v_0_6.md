...
> **Status:** Draft v0.6  
> **Supersedes:** `docs/architecture/graph/graph-schema/versions/graph_schema_v_0_4.md` (internally still labelled v0.3)  
...
- `architecture/change-detection/graph_change_detection_v_0_6.md` and the archived v0.3 docs (patch/streaming behaviour)
...
- Changes from the previous published schema (`docs/architecture/graph/graph-schema/versions/graph_schema_v_0_4.md`, internally v0.3):
