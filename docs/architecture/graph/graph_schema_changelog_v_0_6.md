...
>
> **Status:** Current  
> **Supersedes:** `docs/architecture/graph/archive/graph_schema_changelog_v_0_4.md`
...
For full details, see `docs/architecture/graph/archive/graph_schema_changelog_v_0_4.md`.
