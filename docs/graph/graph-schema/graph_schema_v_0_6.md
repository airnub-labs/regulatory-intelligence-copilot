...
> **Status:** Draft v0.6  
> **Supersedes:** `docs/graph/graph-schema/versions/graph_schema_v_0_4.md` (internally still labelled v0.3)  
...
- Changes from the previous published schema (`docs/graph/graph-schema/versions/graph_schema_v_0_4.md`, internally v0.3):
