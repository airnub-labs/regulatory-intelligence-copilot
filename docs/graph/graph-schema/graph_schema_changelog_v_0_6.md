...
>
> **Status:** Current  
> **Supersedes:** `docs/graph/graph-schema/versions/graph_schema_changelog_v_0_4.md`
...
For full details, see `docs/graph/graph-schema/versions/graph_schema_changelog_v_0_4.md`.
...
- Tight alignment with `docs/engines/timeline-engine/timeline_engine_v_0_2.md`.
