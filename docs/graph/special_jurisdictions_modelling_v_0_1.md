...
Timeline nodes (as per `docs/engines/timeline-engine/timeline_engine_v_0_2.md`) should be attached to
...
- Any future changes to how these are modelled must:
  ...
  2. Update `docs/graph/graph-schema/versions/graph_schema_v_0_3.md` (or later version) and the graph
     changelog.
