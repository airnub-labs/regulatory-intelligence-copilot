...
async function validateMigrations() {
  ...
  console.log('-'.repeat(60))
  logResult('copilot_core schema', await checkSchemaExists('copilot_core'))
  ...
  console.log('-'.repeat(60))
  logResult('tenants table', await checkTableExists('copilot_core', 'tenants'))
  logResult('tenant_memberships table', await checkTableExists('copilot_core', 'tenant_memberships'))
  logResult('user_preferences table', await checkTableExists('copilot_core', 'user_preferences'))
  console.log()

  // Check 3: Conversation Tables
  console.log('💬 Check 3: Conversation Tables')
  console.log('-'.repeat(60))
  logResult('conversations table', await checkTableExists('copilot_core', 'conversations'))
  logResult('conversation_messages table', await checkTableExists('copilot_core', 'conversation_messages'))
  logResult('conversation_contexts table', await checkTableExists('copilot_core', 'conversation_contexts'))
  logResult('conversation_paths table', await checkTableExists('copilot_core', 'conversation_paths'))
  console.log()

  // Check 4: Cost Tracking Tables
  console.log('💰 Check 4: Cost Tracking Tables')
  console.log('-'.repeat(60))
  logResult('llm_cost_records table', await checkTableExists('copilot_core', 'llm_cost_records'))
  logResult('e2b_cost_records table', await checkTableExists('copilot_core', 'e2b_cost_records'))
  logResult('cost_quotas table', await checkTableExists('copilot_core', 'cost_quotas'))
  console.log()

  // Check 5: Execution Contexts
  console.log('🔧 Check 5: Execution Contexts')
  console.log('-'.repeat(60))
  logResult('execution_contexts table', await checkTableExists('copilot_core', 'execution_contexts'))
  console.log()

  // Check 6: RLS Policies
  console.log('🔒 Check 6: RLS Enabled')
  console.log('-'.repeat(60))
  logResult('RLS on tenants', await checkRLSEnabled('copilot_core', 'tenants'))
  logResult('RLS on tenant_memberships', await checkRLSEnabled('copilot_core', 'tenant_memberships'))
  logResult('RLS on conversations', await checkRLSEnabled('copilot_core', 'conversations'))
  logResult('RLS on conversation_contexts', await checkRLSEnabled('copilot_core', 'conversation_contexts'))
  logResult('RLS on execution_contexts', await checkRLSEnabled('copilot_core', 'execution_contexts'))
  console.log()
  ...
  console.log('-'.repeat(60))
  logResult('get_user_tenants function', await checkFunctionExists('copilot_core', 'get_user_tenants'))
  logResult('switch_tenant function', await checkFunctionExists('copilot_core', 'switch_tenant'))
  logResult('verify_tenant_access function', await checkFunctionExists('copilot_core', 'verify_tenant_access'))
  logResult('cleanup_old_terminated_contexts function', await checkFunctionExists('copilot_core', 'cleanup_old_terminated_contexts'))
  logResult('get_conversations_needing_compaction function', await checkFunctionExists('copilot_core', 'get_conversations_needing_compaction'))
  console.log()
