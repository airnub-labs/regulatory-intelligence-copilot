...
- **Node.js** 24+ (LTS) – see `docs/architecture/runtime/node_24_lts_rationale.md` for why.
...
docs/
  ...
  architecture/
    ...
    runtime/
      ...
      node_24_lts_integration_checklist.md
  ...
  governance/
    ...
    product/
      eligibility-explorer/
        eligibility_explorer_spec_v_0_1.md
  development/
    local/
