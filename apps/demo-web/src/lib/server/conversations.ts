...
// Allow dev-like behavior during dev/test phases and production build (for static analysis).
// The actual runtime check will still enforce credentials in production.
